...
```{r}
bg_chem <- read_csv(here::here("data","raw data", "BGchem2008data.csv"))
```
...
#The observed nitrogen-to-phosphate ratio (~6:1) is lower than the canonical Redfield ratio of 16:1 suggesting relatively nitrogen-limited conditions in this dataset.
